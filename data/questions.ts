...
export const QUESTIONS: Question[] = [
  ...
  // Chapter II — Spirit & Archetype
  {
    ...
    prompt: 'Which animal feels most like your spirit ally right now?',
    helper: 'Wolf, owl, serpent, raven, horse, bear… don\'t think. Trust the first one that arrives. This shapes the heart of your crest.',
    type: 'textarea',
